...
//            initPermission();
            if (userRepository.findByUsername(ADMIN_USER_NAME).isEmpty()) { // chưa có tk admin
                ...
                Set<String> adminPermissions = Set.of(
                        "GET_USER",
                        "GET_ALL_ROLES", "GET_ALL_PERMISSIONS", "GET_ALL_USERS",
                        "UPDATE_ROLE", "UPDATE_PERMISSION", "UPDATE_USER",
                        "DELETE_ROLE", "DELETE_PERMISSION", "DELETE_USER",
                        "CREATE_ROLE", "CREATE_PERMISSION", "CREATE_USER",
